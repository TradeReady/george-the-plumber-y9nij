  ...
  return (
    <div style={{ fontFamily: fontStyle, backgroundColor: bg, color: textColor }}>
      ...
      <section style={{ position:'relative', minHeight:'100vh', display:'flex', alignItems:'center', overflow:'hidden', backgroundColor: textColor }}>
        ...
        <div style={{ position:'relative', zIndex:10, maxWidth:1152, margin:'0 auto', padding:'128px 24px 80px', width:'100%' }}>
          <div style={{ maxWidth:640 }}>
            ...
            <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={{ delay:0.4 }} style={{ display:'flex', flexWrap:'wrap', gap:12 }}>
              {gc.phone && (
                <a href={`tel:${gc.phone}`} style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'14px 24px', color:'#fff', fontWeight:600, fontSize:'0.875rem', border:'1px solid rgba(255,255,255,0.3)', borderRadius:buttonRadius, textDecoration:'none', backdropFilter:'blur(4px)' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.7a16 16 0 0 0 6 6l.86-.86a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21.5 16z"/></svg>
                  Call Now
                </a>
              )}
              <a href="#contact" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'14px 24px', backgroundColor:primary, color:'#fff', fontWeight:600, fontSize:'0.875rem', borderRadius:buttonRadius, textDecoration:'none' }}>
      ...
      {benefits.length > 0 && (
        <section id="about" style={{ padding:'80px 0', backgroundColor:'#fff' }}>
          <div style={{ maxWidth:1152, margin:'0 auto', padding:'0 24px', display:'grid', gridTemplateColumns:'1fr 1fr', gap:48, alignItems:'center' }}>
            ...
            <motion.div initial={{ opacity:0, x:30 }} whileInView={{ opacity:1, x:0 }} viewport={{ once:true }}
              ...
              {[
                ...
                <div key={i} style={{ borderRadius:12, padding:24, textAlign:'center',
                  backgroundColor: i%2===0 ? primary : `${primary}15`,
                  color: i%2===0 ? '#fff' : textColor }}>
                  <div style={{ fontSize:'1.875rem', fontWeight:800, marginBottom:4 }}>{stat.value}</div>
      ...
      <section style={{ position:'relative', overflow:'hidden', padding:'96px 0', backgroundColor:textColor }}>
        ...
        <div style={{ position:'relative', zIndex:10, maxWidth:960, margin:'0 auto', padding:'0 24px', display:'flex', flexWrap:'wrap', alignItems:'center', gap:48 }}>
          ...
          <motion.div initial={{ opacity:0, x:30 }} whileInView={{ opacity:1, x:0 }} viewport={{ once:true }} style={{ display:'flex', flexDirection:'column', gap:16, minWidth:260 }}>
            {gc.phone && (
      ...
      <section id="contact" style={{ padding:'80px 0', backgroundColor:'#fff', overflow:'hidden' }}>
        <div style={{ maxWidth:1152, margin:'0 auto', padding:'0 16px', display:'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 32 : 48, alignItems:'start' }}>
          ...
          <motion.div initial={{ opacity:0, x:20 }} whileInView={{ opacity:1, x:0 }} viewport={{ once:true }}
            style={{ backgroundColor:'#fff', borderRadius:20, padding:40, boxShadow:'0 4px 24px rgba(0,0,0,0.09)', border:'1px solid #f3f4f6' }}>
            {submitted ? (
